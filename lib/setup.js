...
export const cliInputs = function () {
  ...
  const flags = {
    ...
    appKey: {
      shortFlag: 'ak',
      type: 'string',
      default: flagsConfig.appKey,
      helpText: [
        '--app-key "<client-id>:<client-secret>" or --ak "<client-id>:<client-secret>"',
        '* overrides built-in spotify app credentials',
        'eg. $ spotifydl --ak "yourClientId:yourClientSecret" <url>',
      ],
    },
    username: {
      shortFlag: 'u',
